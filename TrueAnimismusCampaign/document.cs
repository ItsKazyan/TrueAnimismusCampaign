...
public class Document
{
    ...
    private static void DocumentScreen_Method_50(On.DocumentScreen.orig_method_50 orig, DocumentScreen documentScreen_self, float timeDelta)
    {
        ...
        if (Input.IsLeftClickPressed() || Input.IsSdlKeyPressed(SDL.enum_160.SDLK_ESCAPE))
        {
            ...
            // {
            // 	GameLogic.field_2434.method_945(new TACCreditsScreen(), (Maybe<class_124>)Transitions.field_4109, (Maybe<class_124>)Transitions.field_4108);
            // }
            // else
            // {
            ...
            // }
            // SINCE CREDITS WILL BE A PART OF THE CHAMPAGNE PUZZLE TIP, IGNORE EVERYTHING CREDITS-RELATED
        }
    }
