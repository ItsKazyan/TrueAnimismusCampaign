...
public class CutscenePatcher
{
	...
	public static Texture creditsBackground => Backgrounds["tac-cutscene-ch0-spill"]; // CHANGE TO EXTENDED PERIODIC TABLE
	...
	public static void LoadCutscenes(List<CutsceneModelTAC> Cutscenes)
	{
