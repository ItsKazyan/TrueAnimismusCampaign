...
public sealed class TACCreditsScreen : IScreen
{
    private float timer;
    ...
    private static void setCreditsSeen_TAC() => GameLogic.field_2434.field_2451.field_1929.method_858("TAC-CreditsSeen", true.method_453());
    private static bool getCreditsSeen_TAC() => GameLogic.field_2434.field_2451.field_1929.method_862(new delegate_384<bool>(bool.TryParse), "TAC-CreditsSeen").method_1090(false);
    ...
    public void method_50(float timeDelta)
    {
        ...
        Vector2 textPosition = class_115.field_1433 / 2 + ModelHelpersTAC.Vector2FromString(creditsModel.PositionOffset) * scalar;
        ...
        if ((getCreditsSeen_TAC() && Input.IsSdlKeyPressed(SDL.enum_160.SDLK_ESCAPE)) || timer >= class310.time)
        {
            exitCredits();
        }
    }
